exports.handler = async (event) => {
  ...
  try {
    ...
    // 1. First get all legislative districts for this location
    ...
    // 2. Get officials from the main endpoint
    ...
    // 3. Get non-legislative districts (mayors, governors, etc.)
    ...
    // 4. Try to get election-related officials
